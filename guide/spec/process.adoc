...
The following diagrams illustrates the basic EHF Pre-Award Catalogue and EHF Pre-Award Catalogue Request processes.

.EHF Pre-Award Catalogue process.
image::images/catalogueDiagram.png[align="center"]


.EHF Pre-Award Catalogue Request process.
image::images/catalogueRequestDiagram.png[align="center"]
