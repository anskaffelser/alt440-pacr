...
[source, xml, indent=0]
----
include::../../{snippet-dir}/Catalogue-guide.xml[tags=CatalogueLine-DispatchUnit]
----
...
[source, xml, indent=0]
----
include::../../{snippet-dir}/Catalogue-guide.xml[tags=CatalogueLine-TradedUnit]
----
<1>  References the sellers item identification for the component line
...
[source, xml, indent=0]
----
include::../../{snippet-dir}/Catalogue-guide.xml[tags=CatalogueLine-ConsumerUnit]
----
