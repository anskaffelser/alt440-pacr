...
[source, xml, indent=0]
----
include::../../{snippet-dir}/Catalogue-guide.xml[tags=BundledProducts]
----

.Logistics structure
[source, xml, indent=0]
----
include::../../{snippet-dir}/Catalogue-guide.xml[tags=LogisticsStructure]
----

.Accessories
[source, xml, indent=0]
----
include::../../{snippet-dir}/Catalogue-guide.xml[tags=Accessories]
----
