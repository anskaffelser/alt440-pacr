...
<cac:Item>
    ...
    <cac:AdditionalItemProperty>
      ...
      <cbc:ValueQualifier>Mengde fett<cbc:ValueQualifier>
...
[source,xml]
.UBL example of applying Additional item property in Pre-Award catalogue request. We continue with the presented example.
----
<cac:Item>
    <!-- ... -->
    <cac:AdditionalItemProperty>
      <cbc:ID>1</ID>
      <cbc:Name>OrderableUnit</cbc:Name>
      <cbc:NameCode>PROP</NameCode>
      <cbc:Value>CT</cbc:Value>
      <cbc:ValueQuantity><cbc:ValueQuantity>
      <cbc:ValueQualifier>Papp kartong<cbc:ValueQualifier>
      <cbc:ImportanceCode>M</cbc:ImportanceCode>
      <!-- ... -->
      <cac:ItemPropertyRange>
        <cbc:MinimumValue></cbc:MinimumValue>
        <cbc:MaximumValue></cbc:MaximumValue>
      </cac:ItemPropertyRange>
    </cac:AdditionalItemProperty>
    <!-- ... -->
</cac:Item>
